...
try:
    ...
    # If pywinctl module is not found, those methods will not be available.
    def _couldNotImportPyWinCtl(*unused_args, **unused_kwargs):
        """
        This function raises PyAutoGUIException. It's used for the PyWinCtl function names if the PyWinCtl
        module failed to be imported.
        """
        raise PyAutoGUIException(
            "PyAutoGUI was unable to import pywinctl. Please install this module to enable the function you tried to call."
        )

    Window = _couldNotImportPyWinCtl
    getActiveWindow = _couldNotImportPyWinCtl
    getActiveWindowTitle = _couldNotImportPyWinCtl
    getWindowsAt = _couldNotImportPyWinCtl
    getWindowsWithTitle = _couldNotImportPyWinCtl
    getAllWindows = _couldNotImportPyWinCtl
    getAllTitles = _couldNotImportPyWinCtl
